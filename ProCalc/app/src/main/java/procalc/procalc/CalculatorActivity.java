...
public class CalculatorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        code = sharedpreferences.getString("secretCode", "");
        Log.d("URL", "NOT FIRST TIME " +  code);
    ...
    public void onClickListenerEqual(View v)
    {
        ...
        if(currentString.equals(code)) {
            ...
            if(currentString.equals(mPhoneNumber)){
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
                alertDialogBuilder.setCancelable(true);
                alertDialogBuilder.setMessage("Your pin is " + code);
